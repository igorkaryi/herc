 ...
 * @param version description of param here removes warning
 * @param level description of param here removes warning
 ...
 * @param mode description of param here removes warning
 * @param version description of param here removes warning
 ...
 * @param mask description of param here removes warning
 * @param level description of param here removes warning
 * @return BCH encoded format information pattern
 */
